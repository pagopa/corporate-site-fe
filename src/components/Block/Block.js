...
const Block = ({ data, locale }) => {
  return (
    <>
      {data.fieldGroupName ===
        'Page_Flexiblecontent_Body_Blocks_HeroSlider' && (
      ...
      {data.fieldGroupName ===
        'Page_Flexiblecontent_Body_Blocks_BlockVisualText' && (
        <VisualText data={data} classes="block-visual-text" locale={locale} />
      )}
      {data.fieldGroupName ===
        'Page_Flexiblecontent_Body_Blocks_UsefulLinks' && (
      ...
      {data.fieldGroupName ===
        'Page_Flexiblecontent_Body_Blocks_BlockIntro' && (
      ...
      {data.fieldGroupName ===
        'Page_Flexiblecontent_Body_Blocks_BlockBannerCta' && (
        <CtaBanner data={data} classes="block-cta-banner" locale={locale} />
      )}
      {data.fieldGroupName ===
        'Page_Flexiblecontent_Body_Blocks_BlockCtaGrid' && (

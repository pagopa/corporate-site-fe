  ...
  return (
    <>
      <nav className="pagination">
        {isFirstPage ? (
          <button disabled className="pagination__nav --prev">
            <span>Precedente</span>
          </button>
        ) : (
          <Link
            to={`${pageUri}/${
              humanPageNumber - 1 === 1 ? '' : humanPageNumber - 1
            }`}
            className="pagination__nav --prev"
          >
            <span>Precedente</span>
          </Link>
        )}
        ...
        {isLastPage ? (
          <button disabled className="pagination__nav --next">
            <span>Avanti</span>
          </button>
        ) : (
          <Link
            to={`${pageUri}/${humanPageNumber + 1}`}
            className="pagination__nav --next"
          >
            <span>Avanti</span>
          </Link>
        )}
